...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'sabino' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'sabino' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'sabino' ),
		'cyrillic'     => __( 'Cyrillic', 'sabino' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'sabino' ),
		'devanagari'   => __( 'Devanagari', 'sabino' ),
		'greek'        => __( 'Greek', 'sabino' ),
		'greek-ext'    => __( 'Greek Extended', 'sabino' ),
		'khmer'        => __( 'Khmer', 'sabino' ),
		'latin'        => __( 'Latin', 'sabino' ),
		'latin-ext'    => __( 'Latin Extended', 'sabino' ),
		'vietnamese'   => __( 'Vietnamese', 'sabino' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'sabino' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'sabino' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'sabino' ),
