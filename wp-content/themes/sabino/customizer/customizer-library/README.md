...
To see how this works in practice, please see the [Customizer Library Demo](https://github.com/devinsays/customizer-library-nikkon) theme.
...
$sections[] = array(
	'id' => 'example', // Required
	'title' => __( 'Example Section', 'nikkon' ), // Required
...
$panels[] = array(
	'id' => $panel,
	'title' => __( 'Panel Examples', 'nikkon' ),
	'priority' => '100'
);
...
$options['example-panel-text'] = array(
	...
	'label'   => __( 'Example Text Input', 'nikkon' ),
	'section' => $section,
	'type'    => 'text',
);
~~~
...
$options['example-url'] = array(
	'id' => 'example-url',
	'label'   => __( 'Example URL Input', 'nikkon' ),
	'section' => $section,
	'type'    => 'url',
);
~~~
...
$options['example-checkbox'] = array(
	'id' => 'example-checkbox',
	'label'   => __( 'Example Checkbox', 'nikkon' ),
	'section' => $section,
	'type'    => 'checkbox',
	'default' => 0,
);
...
$options['example-select'] = array(
	'id' => 'example-select',
	'label'   => __( 'Example Select', 'nikkon' ),
	'section' => $section,
	'type'    => 'select',
	'choices' => $choices,
	'default' => 'choice-1'
...
$options['example-dropdown-pages'] = array(
	...
	'label'   => __( 'Example Drop Down Pages', 'nikkon' ),
	'section' => $section,
	'type'    => 'dropdown-pages',
	'default' => ''
);
...
$options['example-upload'] = array(
	'id' => 'example-upload',
	'label'   => __( 'Example Upload', 'nikkon' ),
	'section' => $section,
	'type'    => 'upload',
	'default' => '',
);
...
$options['example-textarea'] = array(
	'id' => 'example-textarea',
	'label'   => __( 'Example Textarea', 'nikkon' ),
	'section' => $section,
	'type'    => 'textarea',
	'default' => __( 'Example textarea text.', 'nikkon'),
);
~~~
...
$options['example-range'] = array(
	'id' => 'example-range',
	'label'   => __( 'Example Range Input', 'nikkon' ),
	'section' => $section,
	'type'    => 'range',
	'input_attrs' => array(
        'min'   => 0,
...
https://github.com/devinsays/customizer-library-nikkon/blob/master/inc/customizer-options.php
...
function nikkon_fonts() {
	...
	// Load Google Fonts
	wp_enqueue_style( 'nikkon_fonts', $font_uri, array(), null, 'screen' );

}
add_action( 'wp_enqueue_scripts', 'nikkon_fonts' );
~~~
